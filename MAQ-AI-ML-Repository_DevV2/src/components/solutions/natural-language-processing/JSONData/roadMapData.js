...
const roadMapData = createSchema({
    nodes: [
        { id: 'node-1', content: 'Discovery', coordinates: [150, 300], },
        { id: 'node-2', content: 'Project Setup', coordinates: [300, 200], },
        { id: 'node-3', content: 'Development', coordinates: [450, 100], },
        { id: 'node-4', content: 'Live Release', coordinates: [600, 200], },
        { id: 'node-5', content: 'Support', coordinates: [750, 300], },
        // { id: 'node-6', content: 'Support', coordinates: [850, 200], },
