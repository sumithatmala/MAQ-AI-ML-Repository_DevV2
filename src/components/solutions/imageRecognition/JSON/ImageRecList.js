...
export const industrialCards = [
    ...
    {label: "Logistics", disc:"Utilize machine learning algorithms for image processing to analyze, plan, design, and control transferring processes, cargo locations, routes, and monitor delivery status in real time.", img: <img src={logistics} alt="Logistics"  className="imgSize"></img>},
    {label: "Media", disc:"Get a solid bespoke solution developed for your needs to analyze visual content, provide your consumers with highly accurate and diverse recommendations, foster user engagement, and reach new audiences.", img: <img src={Media} alt="Media"  className="imgSize"></img>},
    {label: "Digital Health", disc:"Facilitate analysis of medical images, enable computer-aided diagnostics, allow predictive analytics and therapy, enhance mobile healthcare apps with custom computer vision software development.", img: <img src={health} alt="Health"  className="imgSize"></img>},
    {label: "Retail", disc:"Improve search experience by developing image recognition and analysis software solutions to please your customers with intelligent search by photo and help them find merchandise easily.", img: <img src={retail} alt="Retail" className="imgSize"></img>},
    {label: "Robotics", disc:"Enable machines to efficiently perform a variety of repetitive tasks, such as object and target recognition, navigation, manufacturing & assembly, assisting physically challenged people with image processing techniques, etc.", img: <img src={robot} alt="Robot"  className="imgSize"></img>},
    {label: "Automotive", disc:"Amplify design of complex geometries with deep learning techniques. Geometry AI solutions for the automotive industry allow for a safe product design with real-time simulation while reducing costs and engineering effort.", img: <img src={automobile} alt="Automobile" className="imgSize"></img>},
]
