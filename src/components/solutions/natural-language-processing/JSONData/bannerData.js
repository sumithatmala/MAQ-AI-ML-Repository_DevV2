...
const bannerData = [
    {
        ...
        points:"",
        img: <LazyLoadImage src= {sentimentAlt} placeholderSrc={sentimentAlt} alt= "Sentiment Analysis" className="imgSize" effect="blur"/>,
    },
    {
        ...
        points:"",
        img: <LazyLoadImage src= {dataCollectionAlt} placeholderSrc={dataCollectionAlt} alt= "Data Collection" className="imgSize" effect="blur"/>,
    },
    {
        ...
        points:"",
        img: <LazyLoadImage src= {GPTImgAlt} placeholderSrc={GPTImgAlt} alt= "ChatGPT" className="imgSize" effect="blur"/>,
    },
    {
        ...
        points:"",
        img: <LazyLoadImage src= {customerAlt} placeholderSrc={customerAlt} alt= "cutomer" className="imgSize" effect="blur"/>,
    },
    {
        ...
        points:"",
        img: <LazyLoadImage src= {analysisAlt} placeholderSrc={analysisAlt} alt= "Audience Analysis" className="imgSize" effect="blur"/>,
    },
    {
        ...
        points:"",
        img: <LazyLoadImage src= {contextAlt} placeholderSrc={contextAlt} alt= "Context Awareness" className="imgSize" effect="blur"/>,
    },
];
