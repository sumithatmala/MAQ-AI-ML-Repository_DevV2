...
const AccessibleTabsData = [
  {
    ...
    list: "Medical Diagnosis Assistance",
    title: "Medical Diagnosis Assistance",
    content:
      "Assist healthcare professionals in diagnosing diseases, interpreting medical reports, and recommending treatment plans based on patient symptoms and medical history.",
    ...
    image: (
      <img
        width="736"
        height="512"
        src={chatbots_and_virtual_assistants}
        alt="Medical Diagnosis Assistance"
      />
    ),
  },
  {
    heading: "Legal Document Analysis",
    list: "Legal Document Analysis",
    title: "Legal Document Analysis",
    content:
      "Analyze legal documents, contracts, and case law to identify relevant information, extract key insights, and provide legal professionals with valuable research support.",
    ...
    image: (
      <img
        width="736"
        height="512"
        src={translation_and_language_services}
  ...
  },
  {
    ...
    list: "Financial Forecasting",
    title: "Financial Forecasting",
    content:
      "Predict market trends, analyze financial data, and generate accurate forecasts for stock prices, investment opportunities, and economic indicators using advanced machine learning techniques.",
  ...
  },
  {
    ...
    list: "Customer Service Automation",
    title: "Customer Service Automation",
    content:
      "Automate customer support processes, respond to inquiries, and resolve issues efficiently using chatbots, virtual assistants, and natural language processing capabilities.",
  ...
  },
  {
    ...
    content:
      "Assist software developers in writing code, generating scripts, and automating repetitive programming tasks to improve productivity and accelerate software development cycles.",
  ...
  },
  {
    ...
    list: "Environmental Monitoring",
    title: "Environmental Monitoring",
    content:
      "Monitor environmental conditions, analyze climate data, and predict natural disasters such as floods, wildfires, and hurricanes to facilitate disaster preparedness and response efforts.",
    ...
    image: (
      <img
        width="736"
        height="512"
        src={personalized_recommendations}
  ...
  },
  {
    ...
    list: "Personalized Education",
    title: "Personalized Education",
    content:
      "Tailor educational content and learning experiences to individual students based on their learning styles, preferences, and academic performance to enhance engagement and improve learning outcomes.",
