...
const OCDataHealth = [
  {
    ...
    image: <img src={medical} alt="Medical Imaging Analysis" style={{maxHeight:"200px", width:"auto"}} />,
    description: [
  ...
  },
  {
    ...
    image: <img src={therapy} alt="Physical Therapy Transformation" style={{maxHeight:"200px", width:"auto"}} />,
    description: [
  ...
  },
  {
    ...
    image: <img src={auth} alt="Computer Vision Authentication Processes" style={{maxHeight:"200px", width:"auto"}} />,
    description: [
  ...
  },
  {
    ...
    image: <img src={cust} alt="Computer Vision Customer Services Enhancement" style={{maxHeight:"200px", width:"auto"}} />,
    description: [
