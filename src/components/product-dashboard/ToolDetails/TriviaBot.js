    ...
    businessOutcomes: [
        {
            ...
            image: <img src={IncreasedCustEngage} width="100px" style={iconSizeBO} />
        },
        {
            ...
            image: <img src={EnhancedDataCollection} width="100px" style={iconSizeBO} />
        },
        {
            ...
            image: <img src={EfficientReport} width="100px" style={iconSizeBO} />
        },
        {
            title: "Data-Driven Decision-Making",
            description: ["Score card report generated by Trivia Bot offers valuable metrics and insights, empowering business analysts to make data-driven decisions and identify trends or areas of improvement."],
        ...
        },
        {
            ...
            image: <img src={MotivatedPart} width="100px" style={iconSizeBO} />
        },
        {
            title: "Cost Saving",
            description: ["Automation reduces the need for manual labor, resulting in cost savings associated."],
            image: <img src={CostSaving} width="100px" style={iconSizeBO} />
        },
    ],
    solutionHighlights: [
